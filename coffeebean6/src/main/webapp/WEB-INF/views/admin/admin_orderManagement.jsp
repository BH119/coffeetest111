    ...
    <!-- 사이드메뉴 -->
		...
		<div id="adminMain">
			<div id="adminSection">
				...
				<div class="adminDiv">
					기간검색
					<button style="background-color: #ffffff; border-color: #ffffff;"
						type="submit">전체</button>
					<button style="background-color: #ffffff; border-color: #ffffff;"
						type="submit">오늘</button>
					<button style="background-color: #ffffff; border-color: #ffffff;"
						type="submit">어제</button>
					<button style="background-color: #ffffff; border-color: #ffffff;"
						type="submit">1개월</button>
					<button style="background-color: #ffffff; border-color: #ffffff;"
						type="submit">6개월</button>
				</div>
						...
						<tbody>
							<c:forEach var="dto" items="${ list }">
								<tr>
									...
									<td><fmt:formatDate value="${ dto.o_REGDATE}"
											pattern="yyyy-MM-dd" />1</td>
									<td><select name="orderState"
										...
										<button type="submit" value="변경">변경</button></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
